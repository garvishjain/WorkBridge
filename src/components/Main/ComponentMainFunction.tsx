                      ...
                      <div className="col-lg-4 col-md-6">
                        <div className="single-project mb-30">
                          ...
                          <div className="project-cap">
                            <a href="project_details.html" className="plus-btn">
                            ...
                            <h4>
                              <a href="project_details.html">Factory</a>
                            </h4>
                          </div>
                        </div>
                      </div>
            ...
            <div className="col-xl-6 col-lg-6 col-md-6">
              ...
              <div className="single-news mb-30">
                ...
                <div className="news-caption">
                  ...
                  <a href="single-blog.html" className="d-btn">
                    Read more »
                  </a>
                </div>
              </div>
...
export default ComponentMainFunction;
